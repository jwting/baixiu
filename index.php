...
$sql = "select p.id,p.title,p.created,p.feature,p.content,p.views,p.likes,c.name,u.nickname,
  ...
  <div class="wrapper">
    ...
    <div class="content">
      <div class="swipe">
        ...
        <p class="cursor"><span ></span><span></span><span></span><span></span></p>
